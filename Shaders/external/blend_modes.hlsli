...
// Adapted from https://www.ryanjuckett.com/photoshop-blend-modes-in-hlsl/
// Cross referenced with ../../../docs/photoshop_blend_modes.pdf

// Ironclad Modification:
// Seperable blend modes (blend modes that operate on each color channel individually).
...
// Ironclad Modification:
// Non-seperable blend modes (operate on the full set of RGB channels in unison. Specifically they operate on hue, saturation and luminosity).
